...
public class XMLReportGenerator implements IReportGenerator {
	...
	public void generateReportOverall(OverallStatistics statistics) {
		...
		out.println(indent + "<MutationTestOverallStatistics>");
		indent += "  ";
		out.println(indent + "<OverallMutants>" + statistics.getNumberOfMutants() + "</OverallMutants>");
		out.println(indent + "<OverallSurvivors>" + statistics.getNumberOfSurvivors() + "</OverallSurvivors>");

		indent = "";

		out.println("</MutationTestOverallStatistics>");
	}
	...
	public void generateReport(MutationTestSpec mutationTest, List<Mutant> inputMutants, List<Mutant> survived,
		...
		out.println(indent + "<MutationType>" + mutationTest.getOperators() + "</MutationType>");
		...
		for (Mutant m : mutants) {
			...
			out.println(indent + "<MutationType>" + m.getMutationType() + "</MutationType>");
