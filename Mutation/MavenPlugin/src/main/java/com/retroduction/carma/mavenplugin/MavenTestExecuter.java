...
public class MavenTestExecuter {
	...
	public Summary executeTests() throws MojoExecutionException {
		...
		// configure maven specific bean references and add beans to parent factory
		// the names in the parent factory should be unique and not overridden by children, otherwise they would have no effect
