 ...
 * ImageMapDemo1.java
 * ------------------
 * (C) Copyright 2002-2005, by Object Refinery Limited and Richard Atkinson.
 *
 */
    ...
    public static void main(String[] args) {
        ...
        if (drilldown) {
            ...
            renderer.setItemURLGenerator(
                new StandardCategoryURLGenerator("bar_chart_detail.jsp")
            );
            ...
            chart = new JFreeChart(
                "Bar Chart", JFreeChart.DEFAULT_TITLE_FONT, plot, true
            );
        }
        else {
