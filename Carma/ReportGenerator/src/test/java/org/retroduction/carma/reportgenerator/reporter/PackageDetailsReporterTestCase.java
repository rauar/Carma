...
public class PackageDetailsReporterTestCase extends TestCase {
	...
	public void test() {
		...
		expectedResult.append("<td>26.667 %</td>").append("\n");
		expectedResult.append("<td>15</td>").append("\n");
		expectedResult.append("<td>11</td>").append("\n");
		expectedResult.append("<td>4</td>").append("\n");
		expectedResult.append("</tr>").append("\n");

		expectedResult.append("<tr>").append("\n");
		expectedResult.append("<td><a href=\"anotherPackage.html\">anotherPackage</a></td>").append("\n");
		expectedResult.append("<td>1</td>").append("\n");
		expectedResult.append("<td>0 %</td>").append("\n");
		expectedResult.append("<td>7</td>").append("\n");
		expectedResult.append("<td>7</td>").append("\n");
		expectedResult.append("<td>0</td>").append("\n");
		expectedResult.append("</tr>").append("\n");

		expectedResult.append("<tr>").append("\n");
		expectedResult.append("<td><a href=\"package1.html\">package1</a></td>").append("\n");
		expectedResult.append("<td>2</td>").append("\n");
		expectedResult.append("<td>50 %</td>").append("\n");
		expectedResult.append("<td>8</td>").append("\n");
		expectedResult.append("<td>4</td>").append("\n");
		expectedResult.append("<td>4</td>").append("\n");
		expectedResult.append("</tr>").append("\n");
